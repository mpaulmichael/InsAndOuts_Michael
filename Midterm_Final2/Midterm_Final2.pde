...
void draw(){
  ...
  if (scene=="Instruction Screen"){
    ...
    text("1. How long would it take you to get to",width/2,100);
    text("the celebrity you choose",width/2,150);
    text("2. Choose the celebrity that you want to start with",width/2,height/3);
    text("3. Choose the celebrity you want to end with.",width/2,height/2);
    text("4. Click on the celebrities and keep going until",width/2,500);
    text("you get to the celebrity you choose to end with.",width/2,550);
    text("5. Click this screen to continue.",width/2,700);
    if (mousePressed){
      scene="Start Screen";
    }
  }
...

  ...
  if (scene=="Results"){
    ...
    text("You wasted "+time3+" seconds of your life.",width/2,height/2);
    fill(255);
...
void celeblists(String celeb,int cn,StringList whichlist, String celeb1, String celeb2,String celeb3,String celeb4, String celeb5,String celeb6,String celeb7,String celeb8, String celeb9){
  if (scene==celeb){
    ...
    for (int a=0;a<9;a=a+1){
      text("Time so far "+time2,width-50,10);
      fill(255,255,255);
      textSize(30);
